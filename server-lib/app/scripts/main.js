$(document).ready(function(){
  ...
  if (c = new RegExp('https?://[^/]*/kifu/?').exec(url)) {
    ...
    var connection = new WebSocket('ws://192.168.1.40:3001');
